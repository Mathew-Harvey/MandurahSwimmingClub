    ...
    <>
      <header className="page-header">
        <div className="container">
          ...
          <p>Kickstarters Club &ndash; FTGP Club Excellence GOLD</p>
        </div>
      </header>
      <section className="section">
        <div className="container">
          <p className="breadcrumb">
            <Link to="/about">About Us</Link> <span>&rarr;</span> Fuel to Go & Play
          </p>
          ...
          <AnimateIn type="fade-up" delay={100}>
            <div className="prose">
              ...
              <p>
                <a href="https://www.fueltogo.com.au/" target="_blank" rel="noopener noreferrer" className="btn btn--primary btn--pill">Fuel to Go & Play</a>
              </p>
            </div>
          </AnimateIn>
        </div>
