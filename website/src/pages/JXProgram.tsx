    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="prose">
            <p>The 2024–25 Bio Island Australian Junior Excellence (JX) program recognises performances from 1 May 2025 to 30 April 2025. Swimming Australia recognises swimmers aged 9–13 years with gold, silver, bronze or blue standard based on their best performance(s) against the times set by Swimming Australia.</p>
            <p>To qualify, swimmers need to be a member of an Australian swimming club and achieve a qualifying time at an approved meet. <a href="https://www.swimming.org.au/sites/default/files/assets/documents/JX%202021-22%20Qualifying%20Criteria%20and%20Standards_0.pdf" target="_blank" rel="noopener noreferrer">Swimming Australia – JX qualifying times</a>.</p>
          </div>
          <h2>2024–2025 Results</h2>
