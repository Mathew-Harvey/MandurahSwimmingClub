      ...
      <section className="section">
        <div className="container">
          ...
          <div className="prose">
            ...
            <p>Bring: bathers, Mandurah Swimming Club cap and goggles. Arrive 30 mins early to warm up. After warm up you'll be called for marshalling—confirm heat and lane, then follow officials to the blocks. Have fun and ask marshalling staff or Club Captains if you need help.</p>
          </div>
        </div>
      </section>
    </>
